 ...
 *
 * Compile:
 *    gcc -Wall -o conway.x conway.c -lm -fopenmp
 * Usage:
 *    ./conway <cores> <infile name> <# of iterations> <print frequency>
 * Input:
...
{
  if (argc != 5) {
    fprintf(stderr, "usage: ./conway <cores> <infile name> <# of iterations> <print frequency> \n");
    exit(EXIT_FAILURE);
  }
