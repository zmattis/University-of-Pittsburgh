...
int main( int argc, char** argv ) {
  ...
  // Keep the Thread Number and Local Sum Private
  {
    ...
    start = omp_get_wtime( );
    #pragma omp critical( totalSum )   // Named Critical Region - blocks separately.
    {
    ...
    #pragma omp critical( print )      // Named Critical Region - blocks separately.
    {
